    ...
    <div className='flex items-center justify-between py-5 font-medium'>
      ...
      <div className='flex items-center gap-6'>
        ...
        <div className='group relative'>
          <img className='w-5 cursor-pointer' src={icons.profile_icon} alt=""/>
      ...
      <div className={'absolute top-0 right-0 bottom-0 overflow-hidden bg-white transition-all ${visible ? w-full : w-0}'}>
        <div className='flex flex-col text-gray-700'>
          ...
          < NavLink className='py pl-6 border' to='/'>Home</NavLink>
          < NavLink className='py pl-6 border' to='/movies'>Movies Collection</NavLink>
          < NavLink className='py pl-6 border' to='/about'>About</NavLink>
          < NavLink className='py pl-6 border' to='/contact'>Contact</NavLink>
      </div>
    </div>
    </div>
  )
